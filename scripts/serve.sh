...
# package (renamed from vivarium-dashboard). Workspaces now depend on it as a
# regular pip dep; this script is just a convenience wrapper so
# `bash scripts/serve.sh` keeps working.
set -euo pipefail
